    ...
    <>
      ...
      <div>
        <img
          src={passenger}
          alt="passengers"
          className="  w-full opacity-90 md:opacity-70"
        />
      </div>
      <div className="flex justify-around mt-4">
        <button
          className="relative bg-white shadow-md rounded-xl w-32 h-24 flex flex-col items-center justify-center"
        ...
        >
          ...
          <p className="text-sm font-semibold mt-1">Bus Passes</p>
        </button>
        ...
        <dialog id="my_modal_2" className="modal">
          <div className="modal-box">
            ...
            <div className="modal-action">
              <form method="dialog">
                <button className="btn w-full  bg-blue-600 text-white p-3 rounded-lg mt-6 font-semibold">
                  Next Step
                </button>
              </form>
            </div>
